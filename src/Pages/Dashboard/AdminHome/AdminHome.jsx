...
import { FaBook, FaDollarSign, FaProductHunt, FaShippingFast, FaUsers } from 'react-icons/fa';
...
const pieChartData=chartData.map(data=>{
  return {name:data.category,value:data.revnue}
})
    return (
...
<div className="stat">
    ...
    <div className="stat-value">{stats.totalProduct}</div>
    <div className="stat-desc">↗︎ 400 (22%)</div>
</div>
